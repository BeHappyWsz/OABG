$(function() {
	...
	function bindButtonAction() {
		/** 绑定保存事件* */
		$("a[data-action='HYPXSH_CZDOSHBTN']").bind("click", function() {
			doSh();
		});
		$("a[data-action='HYPXSH_BGSDOSHBTN']").bind("click", function() {
			doSh();
		});
		$("a[data-action='HYPXSH_CWDOSHBTN']").bind("click", function() {
			doSh();
		});
	}
