$(function(){
	var URL = {
			gridData : ctx + "/oabg/zlzx/grid",
			formWin : ctx + "/oabg/zlzx/form",
			getInfo : ctx + "/oabg/zlzx/getInfo",
			deleteUrl : ctx +"/oabg/zlzx/delete"
	};
	...
	function renderGrid(){
		grid.datagrid({
			...
			columns:[[
			    ...
			    {field:"zllxName",title:"文件类型",align:"left",halign:"center",width:150},
			    {field:"title",title:"文件标题",align:"left",halign:"center",width:350},
			    {field:"scyh",title:"上传用户",align:"left",halign:"center",width:200},
