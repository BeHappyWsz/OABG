 ...
 */
@Controller
@RequestMapping("/oabg/kqgl/ccspOne")
public class Ccsp_controller extends SimplewebBaseController{
	...
	private final static String MODELPATH="/oabg/kqgl/ccspOne/";
...
/**
	...
	public ModelAndView lcjlFormWin(String id){
		...
		model.addObject("lcjl", ccsp_service.queryFlowById(id));
		return model;
	}
	...
	public ModelAndView spFirst(Long id){
		...
		model.addObject("sp1", ccsq_service.Getinfo(id));
	...
	public Result doSp(String id,String sftg,String suggestion){
		return ccsp_service.doSp(id, sftg, suggestion);
	}
}
